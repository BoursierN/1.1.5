...
public class SciFiName   
{
    ...
    public static void main()
    {
        ...
        String sciFiFirstName = firstName.substring(0,1).toUpperCase() + firstName.substring(1,3).toLowerCase() + lastName.substring(0,2).toLowerCase();
        String sciFiLastName = city.substring(0,1).toUpperCase() + city.substring(1,2).toLowerCase() + school.substring(0,3).toLowerCase();
        String sciFiPlaceOfOrigin = relativeName1.toLowerCase().substring((int)(Math.random() * (double)(relativeName1.length() -1))) +  relativeName2.toLowerCase().substring((int)(Math.random() * (double)(relativeName2.length()-1))) ;
        System.out.println("Hello " + sciFiFirstName + " " + sciFiLastName + " of " + sciFiPlaceOfOrigin.substring(0,1).toUpperCase() + sciFiPlaceOfOrigin.substring(1) + ". Welcome!");
